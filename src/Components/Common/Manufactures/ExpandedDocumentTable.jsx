...
import filterlines from '../../../Svg/filterlines.svg';
 ...
 const ExpandedDocumentTable= ({setHandleExpand }) => {
          ...
          <tbody>
            {ViewDocumentList.map((item, index) => (
              <tr key={index} className="border border-slate-100">
                <td className="border-r-[1px] border-[rgba(242, 244, 247, 1)] text-sm font-medium leading-[16.94px] py-4 px-6 text-[#101828]">
                  {item.DocumentType}
                </td>
                <td className="border-r-[1px] border-[rgba(242, 244, 247, 1)] text-sm font-medium leading-[16.94px] py-4 px-6 text-[#101828]">
                  {item.DocumentNameDescription}
                </td>
                <td className="border-r-[1px] border-[rgba(242, 244, 247, 1)] text-sm font-medium leading-[16.94px] py-4 px-6 text-[#101828]">
                  {item.ServiceType}
                </td>
...
export default ExpandedDocumentTable